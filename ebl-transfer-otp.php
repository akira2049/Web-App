...
if (!isset($_SESSION['ebl_pending_transfer'])) {
    header("Location: ebl-transfer.php");
    exit;
}
...
/* ---------- INFobip SMS CONFIG ---------- */
$BASE_URL = "69qpv8.api.infobip.com"; // example: xxxx.api.infobip.com
$API_KEY  = "84edfec2442bb4c998788856ec770467-9e57587c-493e-4e3b-8e19-8d82e48ec74a";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($entered == "") {
        ...
        header("Location: ebl-transfer-process.php");
        exit;
    } else {
        $error = "Invalid OTP.";
    }
...
<div class="app otp-box">
  ...
  <div class="topbar">
    <a class="linkish" href="ebl-transfer-overview.php">← Back</a>
