  ...
  <main>
    ...
    <section class="hero">
      <div class="container hero-inner">
        ...
        <div class="hero-card" role="region" aria-label="Key features">
            ...
            <li class="feature">
              <span class="ico" aria-hidden="true">
                ...
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8">
                  <ellipse cx="8" cy="6" rx="5" ry="3"></ellipse>
                  <path d="M3 6v5c0 1.7 2.2 3 5 3s5-1.3 5-3V6"></path>
                  <path d="M13 8c2.8 0 5-1.3 5-3s-2.2-3-5-3"></path>
                </svg>
              </span>
              <div>
            ...
            <li class="feature">
              <span class="ico" aria-hidden="true">
                ...
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8">
                  ...
                  <text x="12" y="14" text-anchor="middle" font-size="7" font-family="Arial">50%</text>
                </svg>
              </span>
              <div>
            ...
            <li class="feature">
              <span class="ico" aria-hidden="true">
                ...
                <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.8">
                  ...
                  <path d="M12 8c-2-1-3-3-1.5-4S14 5 12 8Zm0 0c2-1 3-3 1.5-4S10 5 12 8Z"></path>
                </svg>
              </span>
              <div>
